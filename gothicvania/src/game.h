...
#include "gato_anim.h"                  // GATO_*         (generated by tools/adapt_enemy2.py)
#include "ghost_anim.h"                 // GHOST_*        (generated by tools/adapt_enemy2.py)
...
extern unsigned char gato, gatopal, gatopalend;                    // hell-gato: 128-wide 4KB metasprite bands (4 walk) + pal
extern unsigned char ghost, ghostpal, ghostpalend;                 // ghost: 64x64 left-half bands (4 float) + pal
...
#define HERO_OAM       16      // hero  OBJ ids 16,20 -- behind the enemies/poof
#define MOON_OAM       24      // moon  OBJ id 24     -- in the sky, never overlaps anyone
u8 *skeletonFrameSrc(u8 f);
void enemyInit(void);          // load enemy palettes + clear the pool + spawn flags
