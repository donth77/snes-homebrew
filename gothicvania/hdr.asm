...
.ROMBANKS 16                    ; 512 KB (= compo limit) - the enemy sprites (padded 64x64) are heavy

.SNESHEADER
  ID "SNES"                     ; 1-4 letter string, just leave it as "SNES"

  NAME "GOTHICVANIA CEMETERY "  ; Program Title - EXACTLY 21 bytes (pad w/ spaces)
  ;    "123456789012345678901"  ; ruler: NAME must line up to 21 chars

  SLOWROM
  LOROM

  CARTRIDGETYPE $00             ; $00=ROM, $01=ROM+RAM, $02=ROM+SRAM, $03=ROM+DSP1, $04=ROM+RAM+DSP1, $05=ROM+SRAM+DSP1, $13=ROM+Super FX
  ROMSIZE $09                   ; $08=2 Megabits, $09=4 Megabits,$0A=8 Megabits,$0B=16 Megabits,$0C=32 Megabits
